...
//			FileReader readfile = new FileReader("tre-s-92.stu");
		...
		int random2 = 0;
		int tmp = 0;
		Double[] hillclimb = new Double[maxiter];
		...
		for (int j = 0; j < jumlahexam; j++) {
			System.out.print(hasilexam[0][j] + " ");
			System.out.print(hasilexam[1][j] + " ");
			System.out.println();
		}
		System.out.println();

		System.out.println("Penalty Hill Climbing");
		for (int j = 0; j < maxiter; j++) {
			System.out.println(hillclimb[j]);
		}
